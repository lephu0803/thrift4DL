...
network.mnet.pretrained = 'model/mnet025'
network.mnet.pretrained_epoch = 0
...
dataset.retinaface.root_path = '/data/hoatv2/checkpoint/detector/test/mnet'
dataset.retinaface.dataset_path = '/data/hoatv2/datasets/faceid/detector/retinaface'
...
default.root_path = '/data/hoatv2/checkpoint/detector/test/mnet'
default.dataset_path = '/data/hoatv2/datasets/faceid/detector/retinaface'
# default training
default.frequent = 20
default.kvstore = 'device'
# default e2e
default.prefix = '/data/hoatv2/checkpoint/detector/model/mnet'
