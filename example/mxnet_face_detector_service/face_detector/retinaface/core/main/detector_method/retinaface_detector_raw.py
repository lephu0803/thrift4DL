...
class RetinaFaceDetector:
    ...
    def detect(self, img, threshold=0.5, scales=[1.0], do_flip=False, is_need_resize=False):
        proposals_list = []
        scores_list = []
        landmarks_list = []
        ...
        for im_scale in scales:
            for flip in flips:
                if im_scale != 1.0 and is_need_resize:
                ...
                im = np.transpose(im, [0, 3, 1, 2])  # NCHW
